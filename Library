...
local MainGui = game.CoreGui
local folder = Instance.new("Folder", MainGui)
folder.Name = "LaziumTools"
...
local CoreGui = game.CoreGui.LaziumTools
...
elseif CoreGui.Parent.Parent:FindFirstChild("RobloxGui") then
	Rayfield.Parent = CoreGui.Parent.Parent:FindFirstChild("RobloxGui")
else
	Rayfield.Parent = CoreGui
end
...
Topbar.Hide.MouseButton1Click:Connect(function()
	...
	if Hidden then
		Hidden = false
		Minimised = false
		game.CoreGui.LaziumTools.Rayfield.Main.Visible = true
	else
		Hidden = true
		game.CoreGui.LaziumTools.Rayfield.Main.Visible = false
	end
end)
